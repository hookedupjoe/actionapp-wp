/**
 * Action App Dynamic Demo Plugin: ActAppDynoUserInfo/plugin.js
 * 
...
( function ( blocks, element, serverSideRender, blockEditor ) {
    ...
    var tmpActionName = 'ActAppDynoUserInfo:openOptions';
    registerBlockType( 'actappdesign/dynamic-userinfo', {
        apiVersion: 2,
        ...
        edit: function ( props ) {
            ...
            //    el( ServerSideRender, {
            //     block: 'actappdesign/dynamic-userinfo',
