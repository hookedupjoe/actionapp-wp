...
<head>
  ...
  <meta name="viewport"
    ...
    <base href="<?php echo ACTIONAPP_WP_URL . '/apps/ActAppTutorial/' ?>" >
  ...
  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/semantic/dist/semantic.min.css">
  <!-- <link rel="stylesheet" href="/lib/css/dataTables.semanticui.min.css"> -->

  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/tabulator/css/tabulator.min.css">
  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/tabulator/css/semantic-ui/tabulator_semantic-ui.min.css">

  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/css/appframe.css">
  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/css/resp-grid.css">
  ...
  <!-- Local app css -->
  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_URL ?>/apps/ActAppTutorial/app/css/app.css">
  <style>
    .subdemo1 {
      color: red;
    }
  </style>
  <title>Action App Tutorial</title>
</head>
...
<body>
  ...
  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/built-lib/support-libs.js"></script>
  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/semantic/dist/semantic.min.js"></script>

  <!-- <script src="/lib/datatables/datatables.min.js"></script> -->
  <!-- <script src="/lib/jsTree/jstree.min.js"></script> -->

  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/tabulator/js/tabulator.min.js"></script>
  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/tabulator/js/jquery_wrapper.min.js"></script>


  <!-- Action App and Required Items -->
  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/actionapp/actionapp.js"></script>

  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/actionapp/nosql-data-manager.js"></script>
  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/actionapp/object-manager-plugin.js"></script>
  ...
  <script src="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/lib/actionapp/app-module.js"></script>
