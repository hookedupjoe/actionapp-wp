...
(function (ActionAppCore, $) {
    ...
    thisPageSpecs.required = {
        controls: {
            map: {
                "app/catalog/designer/controls/catalog-console/control.js?open&v=0701221341": "panelCatConsole",
                "app/catalog/designer/controls/resource-console/control.js?open&v-0701221341": "resourceConsole"
            }
        },
        panels: {
            map: {
    ...
    */
    ...
    window.WSPage = ThisPage;
    ThisPage.common = ThisPage.common || {};
    ThisPage.common.endpoints = {
    ...
    function addCatalog(theParams, theTarget) {
        ThisPage.getPanel('frmNewCatalog').prompt(
            ...
            //was .common.apiCall
            var tmpURL = ThisPage.parts.center.getBaseURL() + ThisPage.common.endpoints.createCatalog;
            ThisApp.apiCall({
                url: tmpURL,
                data: theData
