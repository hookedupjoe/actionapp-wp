<?php
/**
 * Application Console - Sub Application
 */
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <meta name="viewport"
    ...
    <base href="<?php echo ACTIONAPP_WP_URL . '/apps/AppConsole/' ?>" >

  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_CORE_LIB_URL ?>/built-lib/support-libs.css">


  <!-- Local app css -->
  <link rel="stylesheet" href="<?php echo ACTIONAPP_WP_URL ?>/apps/AppConsole/app/css/app.css">
  <style>
    .subdemo1 {
      color: red;
    }
...
<body>
  ...
  <script src="<?php echo ACTIONAPP_WP_URL ?>/apps/AppConsole/app/app.js"></script>
